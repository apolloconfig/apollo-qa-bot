    ...
    askQuestion: function (question) {
      ...
      eventSource.onmessage = function (event) {
        if (!botMessage) {
          ...
          botMessageDiv.classList.add('qa-bot-message');
          botMessageDiv.innerHTML = '<div class="qa-bot-message-icon">' + QABot.botIconSvg
              + '</div>';
          botMessage = document.createElement('div');
          botMessage.classList.add('qa-bot-message-text');
          botMessageDiv.appendChild(botMessage);
          document.getElementById('qa-bot-message-list').appendChild(botMessageDiv);
        }
      ...
      eventSource.onerror = function (error) {
        alert("Error occurred when asking question. Please try again later.")
      ...
      function reset() {
        ...
        QABot.submitting = false;
        document.getElementById('qa-bot-submit-button').disabled = false;
